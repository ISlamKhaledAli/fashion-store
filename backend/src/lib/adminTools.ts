...
export const adminTools = [
  {
    ...
    function: {
      ...
      description:
        "Gets high-level store performance metrics: total revenue, total orders, total products, total customers, and low stock count.",
      parameters: {
        type: "object",
        properties: {},
        required: [],
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Gets products with variants whose stock is less than or equal to a given threshold.",
      parameters: {
        type: "object",
        properties: {
          threshold: {
      ...
      parameters: {
        ...
        properties: {
          ...
          status: {
            type: "string",
            description:
              "Optional order status to filter by (e.g. PENDING, PROCESSING, SHIPPED, DELIVERED, CANCELLED).",
          },
        },
      },
    },
      ...
      parameters: {
        ...
        properties: {
          period: {
            ...
            description:
              "The time period to calculate top products. Defaults to 30days.",
          },
          limit: {
            type: "number",
            description:
              "Maximum number of top products to return. Defaults to 5.",
          },
        },
      },
    },
  },
  {
    ...
    function: {
      ...
      description:
        "Searches for products by name or description and returns their stock and status.",
      parameters: {
        type: "object",
        properties: {
          query: {
...
export async function executeAdminTool(name: string, args: any) {
  try {
    ...
    logger.error(`Admin tool execution failed for ${name}:`, { error: err });
