...
exports.updateOrderPaymentSchema = exports.updateOrderStatusSchema = exports.createOrderSchema = void 0;
...
exports.updateOrderPaymentSchema = zod_1.z.object({
    stripePaymentId: zod_1.z.string().min(1, "Payment ID is required"),
    paymentStatus: zod_1.z.enum(["PENDING", "PAID", "FAILED", "UNPAID"]).default("PAID"),
});
