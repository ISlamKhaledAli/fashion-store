          ...
          {categories.map((category, index) => (
            ...
            >
              <Link
                ...
                className="group relative block aspect-[3/4] overflow-hidden bg-surface-container-high cinematic-ease"
              >
                <Image
                  src={category.image}
                  alt={category.name}
                  fill
                  className="object-cover transition-transform duration-[0.8s] cinematic-ease group-hover:scale-110"
                />
                ...
                <div className="absolute bottom-8 left-8 z-10">
                  <h3 className="text-on-primary text-2xl font-medium tracking-tight">
                    {category.name}
                  </h3>
